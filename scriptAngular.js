...
next_btn.onclick =()=>{
    ...
    if(que_count < questionsAngularjs.length-1){
        que_count++;
...
function showquestions(index){
    ...
    let que_tag ="<span>"+ questionsAngularjs[index].numb+questionsAngularjs[index].question+"</span>";
    let option_tag='<div class="option">'+questionsAngularjs[index].options[0]+'</div>'
                      +'<div class="option">'+questionsAngularjs[index].options[1]+'</div>'
                      +'<div class="option">'+questionsAngularjs[index].options[2]+'</div>'
                      +'<div class="option">'+questionsAngularjs[index].options[3]+'</div>';
...
function optionSelected(answer){
    ...
    let correctAns=questionsAngularjs[que_count].answer;
