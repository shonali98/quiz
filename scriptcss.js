...
next_btn.onclick =()=>{
    ...
    if(que_count < questionscss.length-1){
        que_count++;
...
function showquestions(index){
    ...
    let que_tag ="<span>"+ questionscss[index].numb+questionscss[index].question+"</span>";
    let option_tag='<div class="option">'+questionscss[index].options[0]+'</div>'
                      +'<div class="option">'+questionscss[index].options[1]+'</div>'
                      +'<div class="option">'+questionscss[index].options[2]+'</div>'
                      +'<div class="option">'+questionscss[index].options[3]+'</div>';
...
function optionSelected(answer){
    ...
    let correctAns=questionscss[que_count].answer;
