...
next_btn.onclick =()=>{
    ...
    if(que_count < questionsdotnet.length-1){
        que_count++;
...
function showquestions(index){
    ...
    let que_tag ="<span>"+ questionsdotnet[index].numb+questionsdotnet[index].question+"</span>";
    let option_tag='<div class="option">'+questionsdotnet[index].options[0]+'</div>'
                      +'<div class="option">'+questionsdotnet[index].options[1]+'</div>'
                      +'<div class="option">'+questionsdotnet[index].options[2]+'</div>'
                      +'<div class="option">'+questionsdotnet[index].options[3]+'</div>';
...
function optionSelected(answer){
    ...
    let correctAns=questionsdotnet[que_count].answer;
