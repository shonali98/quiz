...
function showquestions(index){
    ...
    let que_tag ="<span>"+ questionsreactjs[index].numb+questionsreactjs[index].question+"</span>";
    let option_tag='<div class="option">'+questionsreactjs[index].options[0]+'</div>'
                      +'<div class="option">'+questionsreactjs[index].options[1]+'</div>'
                      +'<div class="option">'+questionsreactjs[index].options[2]+'</div>'
                      +'<div class="option">'+questionsreactjs[index].options[3]+'</div>';
...
function optionSelected(answer){
    ...
    let correctAns=questionsreactjs[que_count].answer;
